...
def main() -> None:
    ...
    parser.add_argument("-l", "--l_nthd", type=int, default=0    , help="The minimal number of threads.")
    parser.add_argument("-r", "--r_nthd", type=int, default=4    , help="The minimal number of threads.")
    parser.add_argument("-s", "--s_nthd", type=int, default=1    , help="The step of number of threads.")
